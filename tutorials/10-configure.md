...
-   **mediaHosts: An array of hosts from which form and instance attachments may be requested. If left empty, media requests are performed according to the same logic as `server url`.**
